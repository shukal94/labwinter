...
import com.solvd.lab.automation.sshukalovich.c3.service.ButtonService;
...
//        boolean tttt = Boolean.valueOf("true");
        ...
        Button o = ButtonFactory.createBlackButton("aa", new Coordinates2D(4, 6), "tt", 10, 20);
        ButtonService.update(o);
